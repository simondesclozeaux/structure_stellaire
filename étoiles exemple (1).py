...
print("Surface Luminiosité: %s Watts" % round(LS[dim - 1], 2))
...
plt.subplot(3, 2, 1)
plt.plot(R[0 : int(dim / 2) - 1], P[0 : int(dim // 2) - 1], "b-")
plt.plot(RS[int(dim / 2) : dim - 1], PS[int(dim // 2) : dim - 1], "c-")
...
plt.plot(RS[int(dim // 2) : dim - 1], LS[int(dim // 2) : dim - 1], "c-")
...
plt.plot(RS[int(dim // 2) : dim - 1], MS[int(dim // 2) : dim - 1], "c-")
...
plt.plot(RS[int(dim // 2) : dim - 1], TS[int(dim // 2) : dim - 1], "c-")
